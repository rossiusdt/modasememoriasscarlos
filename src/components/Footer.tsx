    ...
    <footer className="bg-white border-t border-gray-200 mt-12">
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 border-2 border-[#1a73e8] text-[#1a73e8] font-semibold text-sm px-5 py-2.5 rounded-lg hover:bg-blue-50 transition-colors"
            >
        ...
        <div className="mt-8 pt-6 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-400">
          <p>© {new Date().getFullYear()} Modas e Memórias. Todos os direitos reservados.</p>
